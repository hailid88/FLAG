...
public class ConstructBinaryTreeFromInorderAndPostorderTraversal {
    ...
    public TreeNode buildTree(int[] inorder, int[] postorder, int lIn, int rIn, int lPost, int rPost){
        ...
        newrIn--;
        TreeNode left = buildTree(inorder, postorder, lIn, newrIn, lPost, lPost + newrIn - lIn);
        TreeNode right = buildTree(inorder, postorder, newrIn + 2, rIn, lPost + newrIn -lIn+1, rPost -1);
        root.left = left;
        root.right = right;
        return root;
    }
